...
const CashOut = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/cashout-request',
  ...
  return (
    <div className='max-w-4xl ml-16 md:ml-64'>
      <div>
        <h1 className='text-center bg-black font-serif text-white p-3 text-2xl md:text-4xl'>Welcome to Cash Out</h1>
      </div>
...
//         <div className='max-w-4xl ml-16  md:ml-64'>
//             <div>
//                 <h1 className='text-center bg-black font-serif text-white  p-3 dark:text-white   text-2xl md:text-4xl '>Welcome to  Cash Out</h1>
//             </div>
//             <form className="space-y-4 md:space-y-6 mt-12   " onSubmit={handleSubmit}>
//                 <div>
//                     <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Agent Phone Number</label>
//                     <input 
//                         type="text" 
...
//                     />
//                 </div>
//                 <button type="submit" className="w-full text-sm md:text-4xl text-white bg-green-500 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg  px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Cash Out</button>
//                 {error && <p className="text-sm text-red-500 mt-2">{error}</p>}
//                 {success && <p className="text-sm text-green-500 mt-2">{success}</p>}
